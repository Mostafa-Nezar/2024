...
function createproduct(productsshow ,arr) {
    arr.forEach((e)=>{
        ...
        product.innerHTML=`<div class="cont ">
                        ...
                        <div style="font-weight: 700;">Rp ${e.price}</div>
                        </div>
                        <div class="lay d-grid align-items-center">
                        <div class="text-center">
                        <button class="mb-5">Add To Cart</button>
                        ...
                        <a class="mx-2 text-white fw-bold" href=""><img class="img-fluid" width="25" src="compare.svg"> Compare</a>
